...
it "Manifest-Validierung & VENV Hilfsfunktion"
...
ensure_venv "/tmp/dax-test-venv" "Test VENV" >/dev/null 2>&1
assert_true $? "ensure_venv schließt ohne Fehler ab"
assert_file_exists "/tmp/dax-test-venv/bin/activate" "VENV Activate Script wurde erfolgreich erstellt"
rm -rf "/tmp/dax-test-venv"
